namespace SqlLib.DAL
{
    ...
    public static partial class SqlHelper
    {
        ...
        #region SP Command, Parameter Methods

        public static SqlCommand NewCommand(string spname, string schema = "dbo", bool isContainReturnValue = true)
        {
            var cmd = new SqlCommand("[" + schema.Replace("]", "]]") + "].[" + spname.Replace("]", "]]") + "]") { CommandType = CommandType.StoredProcedure };
            if (isContainReturnValue) cmd.AddReturnValue();
            return cmd;
        }

        public static SqlCommand AddParameter(this SqlCommand cmd, string pname, object value = null, SqlDbType dbType = SqlDbType.NVarChar, bool isOutput = false)
        {
            var p = new SqlParameter(pname, dbType) { Direction = isOutput ? ParameterDirection.InputOutput : ParameterDirection.Input };
        ...
        public static SqlCommand RemoveReturnValue(this SqlCommand cmd)
        {
            cmd.Parameters.RemoveAt("RETURN_VALUE");
            return cmd;
        }

        public static SqlCommand AddReturnValue(this SqlCommand cmd)
        {
            cmd.Parameters.Add(new SqlParameter("RETURN_VALUE", System.Data.SqlDbType.Int, 0, ParameterDirection.ReturnValue, false, 0, 0, null, DataRowVersion.Current, null));
            return cmd;
        }

        public static SqlCommand SetParameterValue(this SqlCommand cmd, string pname, object value)
        {
