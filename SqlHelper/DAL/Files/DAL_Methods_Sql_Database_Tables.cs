...
namespace DAL.Database.Tables.客户
{
    ...
    partial class 订单
    {
        ...
        public static List<订单> Select(Tables.雇员.雇员 parent, Queries.Tables.客户.订单.Handler query = null)
        {
        ...
        public static List<订单> Select(Tables.客户.客户 parent, Queries.Tables.客户.订单.Handler query = null)
        {
