...
namespace DAL.Database.Tables.客户
{
    ...
    partial class 订单
    {
        ...
        public static List<订单> Select(雇员 parent, Queries.Tables.客户.订单.Handler query = null) {
        ...
        public static List<订单> Select(客户 parent, Queries.Tables.客户.订单.Handler query = null) {
...
DELETE FROM [客户].[订单]";
 ...
 WHERE " + ws;
    ...
    partial class 订单明细
    {
        ...
        public static List<订单明细> Select(产品 parent, Queries.Tables.客户.订单明细.Handler query = null) {
        ...
        public static List<订单明细> Select(订单 parent, Queries.Tables.客户.订单明细.Handler query = null) {
